...
class SkinColorMeasurement(Base):
    ...
    melanin: Mapped[Optional[int]] = mapped_column(Integer, comment="추론된 멜라닌 투입량 (0~9)")
    white: Mapped[Optional[int]] = mapped_column(Integer, comment="추론된 화이트 투입량 (0~9)")
    red: Mapped[Optional[int]] = mapped_column(Integer, comment="추론된 레드 투입량 (0~9)")
    yellow: Mapped[Optional[int]] = mapped_column(Integer, comment="추론된 옐로우 투입량 (0~9)")
